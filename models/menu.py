...
#                  _id="web2py-logo")
response.title = 'Miramonte Clubs' # request.application.replace('_', ' ').title()
response.subtitle = ''
...
response.menu = [
    ...
    (T('Clubs'), False, URL('default', 'clubs'), []),
    (T('About Us'), False, URL('default', 'about_us'), []),
    (T('Help'), False, URL('default', 'contact_us'), [])
]

if auth.has_membership('admin', auth.user_id):
